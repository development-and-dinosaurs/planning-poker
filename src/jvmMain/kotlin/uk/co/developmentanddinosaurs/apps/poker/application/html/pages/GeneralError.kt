                ...
                div(classes = "container") {
                    ...
                    div(classes = "content") {
                        ...
                        p(classes = "center-align") {
                            +"""Oh no, this isn't good. Look, something weird has happened and there's an error and we're 
                            |not really sure what's going on.
                            """.trimMargin()
                        }
                        p(classes = "center-align") {
                            +"""Hopefully you've found this page by doing something funky and you're not just trying to 
                            |live your life and have a good time with the site.
                            """.trimMargin()
                        }
                        p(classes = "center-align") {
                            +"""Listen this has probably triggered an alert somewhere so if it wasn't supposed to happen 
                            |it'll probably get fixed at some point.
                            """.trimMargin()
                        }
                        p(classes = "center-align") {
