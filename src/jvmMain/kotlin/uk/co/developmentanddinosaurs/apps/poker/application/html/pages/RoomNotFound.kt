...
fun HTML.roomNotFound(name: String) = run {
            ...
            div(classes = "container") {
                ...
                div(classes = "content") {
                    ...
                    p(classes = "center-align") {
                        +"We've looked everywhere but we just can't seem to find the room you're looking for. $name, was it? Sorry, we definitely don't have a room $name."
                    }
                    p(classes = "center-align") {
                        +"Rooms are removed once all players have left, so you might be looking for an abandoned room that has been cleaned up already."
                    }
                    p(classes = "center-align") {
